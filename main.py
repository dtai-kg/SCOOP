...
if __name__ == "__main__":
    ...
    parser.add_argument('--mappings', type=str, nargs='+', help='Path to folder or rml files to be translated')
    parser.add_argument('--ontology', type=str, nargs='+', help='Path to folder or owl files to be translated')
