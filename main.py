...
if __name__ == "__main__":
    ...
    parser.add_argument('--mappings', type=str, nargs='+', help='Path to folder or mapping files to be translated')
    parser.add_argument('--ontology', type=str, nargs='+', help='Path to folder or ontology files to be translated')
    parser.add_argument('--xsd', type=str, nargs='+', help='Path to folder or xsd file to be translated')
